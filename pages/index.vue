<template>
  <div class="py-16 bg-white">
    <div
      class="container m-auto px-6 space-y-8 text-gray-500 md:px-12 lg:px-20"
    >
      <div
        class="justify-center text-center gap-6 md:text-left md:flex lg:items-center lg:gap-16"
      >
        <div class="order-last mb-6 space-y-6 md:mb-0 md:w-6/12 lg:w-6/12">
          <h1 class="text-4xl text-gray-700 font-bold md:text-5xl">
            Buy now and benefit up to <span class="text-blue-500">30% off</span>
          </h1>
          <p class="text-lg">
            Shop the latest fashion &' shoes online | Free Delivery* &' Returns
            on ALL orders | Over 1900 Brands – new products every day!
          </p>
          <div
            class="flex flex-row-reverse flex-wrap justify-center gap-4 md:gap-6 md:justify-end"
          >
            <NuxtLink to="shop">
              <button
                type="button"
