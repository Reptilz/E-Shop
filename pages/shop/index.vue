    ...
    <div class="container px-6 py-8 mx-auto">
      <div class="lg:flex lg:-mx-2">
        <div class="space-y-3 lg:w-1/5 lg:px-2 lg:space-y-4">
          <a
            href="#"
            class="block font-medium text-gray-500 dark:text-gray-900 hover:underline"
            >Jackets & Coats</a
          >
          <a
            href="#"
          ...
          >
            ...
            >
              <img
                ...
                src="@/assets/medias/tshirtsvests/1.avif"
                alt="T-Shirt"
              />
              <h4
            ...
            >
              <img
                class="object-cover w-full rounded-md h-72 xl:h-80"
                src="@/assets/medias/tshirtsvests/2.avif"
                alt="T-Shirt"
              />
              <h4
                class="mt-2 text-lg font-medium text-gray-700 dark:text-gray-900"
            ...
            >
              <img
                class="object-cover w-full rounded-md h-72 xl:h-80"
                src="@/assets/medias/tshirtsvests/3.avif"
                alt="T-Shirt"
              />
              <h4
                class="mt-2 text-lg font-medium text-gray-700 dark:text-gray-900"
            ...
            >
              <img
                class="object-cover w-full rounded-md h-72 xl:h-80"
                src="@/assets/medias/tshirtsvests/4.avif"
                alt="T-Shirt"
              />
              <h4
                class="mt-2 text-lg font-medium text-gray-700 dark:text-gray-900"
            ...
            >
              <img
                class="object-cover w-full rounded-md h-72 xl:h-80"
                src="@/assets/medias/tshirtsvests/5.jpg"
                alt="T-Shirt"
              />
              <h4
                class="mt-2 text-lg font-medium text-gray-700 dark:text-gray-900"
